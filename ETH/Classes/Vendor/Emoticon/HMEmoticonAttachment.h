...
///
/// @return 属性文本
+ (NSAttributedString * _Nonnull)emoticonStringWithEmoticonForYYLabel:(HMEmoticon * _Nullable)emoticon font:(UIFont * _Nonnull)font textColor:(UIColor * _Nonnull)textColor;
